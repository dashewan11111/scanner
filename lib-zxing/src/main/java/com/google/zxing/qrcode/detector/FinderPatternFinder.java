...
public class FinderPatternFinder {
  ...
  private FinderPattern[] selectBestPatterns() throws NotFoundException {
   ...
   // possibleCenters.sort(moduleComparator);
    sortArrayList(possibleCenters,moduleComparator);
  ...
  private void sortArrayList(List<FinderPattern> possibleCenters, EstimatedModuleComparator moduleComparator) {
    Object[] a = possibleCenters.toArray();
    Arrays.sort(a, (Comparator) moduleComparator);
    ListIterator<FinderPattern> i = possibleCenters.listIterator();
    for (Object e : a) {
      i.next();
      i.set((FinderPattern) e);
    }
  }
